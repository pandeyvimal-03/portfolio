...
function Projects() {
  return (
    <div className=' w-[95vw] sm:w-[82vw] h-auto pl-6 sm:pl-6 mx-auto  py-8 sm:py-24 '>
      ...
      <div className=' w-[100%] flex flex-wrap justify-center gap-4 sm:gap-8 py-2 sm:py-8'>
        {
          project.map((item : any)=>{
            return(
              <div className='h-auto sm:h-[35vh] w-[90%] p-2 sm:p-4 border rounded-md shadow-md border-[#008000] text-white flex flex-col sm:flex-row  justify-between items-center'>
        ...
        {/* <div className='h-[35vh] w-[90%] p-4 border rounded-md shadow-md border-[#008000] text-white flex  justify-between'>
          <Image src={EpmsImg} alt='image' className='h-[220px] w-[380px]  object-fit rounded-md object-center'></Image>
          <div className='w-[60%]'>
              <h2 className='font-bold text-xl text-gray-200 py-2'>Employee Management System - EPMS</h2>
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <br />
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <button className='w-[30%] px-4 py-2 rounded-md bg-green-700 text-white mt-2'>visit</button>
          </div>
        ...
        <div className='h-[35vh] w-[90%] p-4 border rounded-md shadow-md border-[#008000] text-white flex  justify-between'>
          <Image src={RozgarImg} alt='image' className='h-[220px] w-[380px]  object-fit rounded-md object-center'></Image>
          <div className='w-[60%]'>
              <h2 className='font-bold text-xl text-gray-200 py-2'>Job Porta - ROZGAR.COM</h2>
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <br />
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <button className='w-[30%] px-4 py-2 rounded-md bg-green-700 text-white mt-2'>visit</button>
        ...
        <div className='h-[35vh] w-[90%] p-4 border rounded-md shadow-md border-[#008000] text-white flex  justify-between'>
          <Image src={CscImg} alt='image' className='h-[220px] w-[380px]  object-fit rounded-md object-center'></Image>
          <div className='w-[60%]'>
              <h2 className='font-bold text-xl text-gray-200 py-2'>AI Resume Making Tool </h2>
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <br />
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <button className='w-[30%] px-4 py-2 rounded-md bg-green-700 text-white mt-2'>visit</button>
        ...
        <div className='h-[35vh] w-[90%] p-4 border rounded-md shadow-md border-[#008000] text-white flex  justify-between'>
          <Image src={AtsImg} alt='image' className='h-[220px] w-[380px]  object-fit rounded-md object-center'></Image>
          <div className='w-[60%]'>
              <h2 className='font-bold text-xl text-gray-200 py-2'>Resume Analyzer </h2>
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <br />
              <p className='text-gray-400 text-sm'>The images will display clearly, maintain their aspect ratio, and fit within their respective containers without distortion. Adjust the dimensions or objectFit properties if you need different behavior.</p>
              <button className='w-[30%] px-4 py-2 rounded-md bg-green-700 text-white mt-2'>visit</button>
