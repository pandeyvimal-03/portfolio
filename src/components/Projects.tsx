...
function Projects() {
  return (
    <motion.div
      ...
      className=' w-[100vw] sm:w-[82vw] h-auto pl-2 sm:pl-6 mx-auto  py-8 sm:py-24 '
      id='projects'
    >
          ...
          project.map((item: projectItem, index: number) => {
            return (
              <motion.div
                ...
                className='h-auto sm:h-[35vh] w-[90%] p-2 sm:p-4 border rounded-md shadow-md border-[#008000] text-white flex flex-col sm:flex-row  justify-between items-center'
                >
